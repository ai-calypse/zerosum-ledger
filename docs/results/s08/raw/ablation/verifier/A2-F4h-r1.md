# A2-F4h-r1 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A2-F4h-r1"
```

## 7. Raw data

[A2-F4h-r1.json](A2-F4h-r1.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 37 | accounts_compared=251, accounts_drifting=37, drift_abs_minor=119342 |
...
- **I6** (first 10 of 21): `not applied: 01a0b8db-c616-7c1e-8ffc-d45571305a25`, `not applied: 01a0b8db-c620-7668-a7ee-ac1b8f396ab4`, `not applied: 01a0b8db-c62b-74fa-b75f-a87d6c63348e`, `not applied: 01a0b8db-c634-7cd9-aab7-2713909d5c61`, `not applied: 01a0b8db-c63d-7d4a-9d6e-1e4f574d1231`, `not applied: 01a0b8db-c648-7adc-ab88-a49f4ab59e38`, `not applied: 01a0b8db-c653-722d-ba73-6c5940bd9233`, `not applied: 01a0b8db-c65c-76b5-b6cb-b482923959a5`, `not applied: 01a0b8db-c667-7229-8bf2-9fe4744f508b`, `not applied: 01a0b8db-c66f-7b95-82bb-8a5bf5ef6d01`
- **I6b** (first 10 of 37): `driver:a2f4hr1d0/payable/USD ledger=-211083 orders=-213723`, `rider:a2f4hr1r28/receivable/USD ledger=82327 orders=85602`, `rider:a2f4hr1r141/receivable/USD ledger=66821 orders=67422`, `driver:a2f4hr1d45/payable/USD ledger=-253849 orders=-254822`, `driver:a2f4hr1d25/payable/USD ledger=-277045 orders=-281253`, `driver:a2f4hr1d43/payable/USD ledger=-273624 orders=-276334`, `driver:a2f4hr1d29/payable/USD ledger=-287388 orders=-290008`, `rider:a2f4hr1r76/receivable/USD ledger=75709 orders=80224`, `rider:a2f4hr1r92/receivable/USD ledger=108037 orders=111424`, `rider:a2f4hr1r158/receivable/USD ledger=111650 orders=115288`

# A3-F7-r5 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A3-F7-r5"
```

## 7. Raw data

[A3-F7-r5.json](A3-F7-r5.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I7 | provider ground truth ↔ attempts: one provider success per attempt, none unclaimed | **VIOLATED** | 28 | attempts=200, provider_success_records=228, duplicate_charges=28, duplicate_minor=87359, success_without_provider_record=0, provider_success_without_attempt=0, provider_success_on_failed_attempt=0 |

**Overall: FAIL — I7 violated**

Offending rows:

- **I7** (first 10 of 28): `CHARGE 01a0b77c-e383-724b-a252-bf91eadf65dc succeeded 2 times`, `CHARGE 01a0b77c-f812-7bdf-955d-9df6512d4b9e succeeded 2 times`, `CHARGE 01a0b77c-fa0d-7db3-8acb-ef4b0649ad3a succeeded 2 times`, `CHARGE 01a0b77c-fbdb-7dfb-86cf-035fe41efab6 succeeded 2 times`, `CHARGE 01a0b77c-feed-7af2-b3e8-5c4279cfd749 succeeded 2 times`, `CHARGE 01a0b77d-0691-7626-a039-d7756d032628 succeeded 2 times`, `CHARGE 01a0b77d-0799-7199-b4e6-3d8f554ab3d5 succeeded 2 times`, `CHARGE 01a0b77d-0d7e-7cc3-b859-2a409ac6be10 succeeded 2 times`, `CHARGE 01a0b77d-1164-7792-9650-fc524c1392f8 succeeded 2 times`, `CHARGE 01a0b77d-1275-7f1e-93c3-2e7c914fc638 succeeded 2 times`

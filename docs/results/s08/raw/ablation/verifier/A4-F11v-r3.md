# A4-F11v-r3 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A4-F11v-r3"
```

## 7. Raw data

[A4-F11v-r3.json](A4-F11v-r3.json) — the same run, with every check's metrics and its sample of offending rows.

## 8. Results

| Invariant | What it checks | Result | Violations | Metrics |
|---|---|---|---|---|
| I1 | every money order is zero-sum per currency | **VIOLATED** | 64 | orders_checked=6000, unbalanced_orders=64 |
...
**Overall: FAIL — I1 violated**

Offending rows:

- **I1** (first 10 of 64): `01a0b773-38d6-7ac1-ba7a-abf994654d20: USD sums to -1`, `01a0b772-9ffc-7aa4-b908-47b9e453fdf5: USD sums to -1`, `01a0b772-9c96-708b-ab3e-a4368fe3c061: USD sums to 1`, `01a0b772-f68d-7310-bd82-186e172079c9: USD sums to -1`, `01a0b772-b2c3-7c2b-b654-88073b181e52: USD sums to -1`, `01a0b773-563d-7c8a-8308-1ee0f2c13793: USD sums to 1`, `01a0b773-0fe6-7f62-826f-d5be1c6e2909: USD sums to -1`, `01a0b773-3fb8-7bcf-ae81-d2a9a3b80fb3: USD sums to 1`, `01a0b773-3405-7c88-b212-122584a34447: USD sums to 1`, `01a0b772-dc10-7d2b-bab2-5784a3df23d2: USD sums to 1`

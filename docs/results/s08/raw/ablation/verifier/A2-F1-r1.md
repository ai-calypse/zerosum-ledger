# A2-F1-r1 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A2-F1-r1"
```

## 7. Raw data

[A2-F1-r1.json](A2-F1-r1.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 5 | accounts_compared=251, accounts_drifting=5, drift_abs_minor=8472 |
...
- **I6** (first 2 of 2): `not applied: 01a0b736-5fb9-7169-92a3-cb0d5b196e37`, `not applied: 01a0b736-bf95-7928-9554-75a0d56d64c1`
- **I6b** (first 5 of 5): `driver:a2f1r1d0/payable/USD ledger=-319072 orders=-321733`, `rider:a2f1r1r34/receivable/USD ledger=130799 orders=134125`, `rider:a2f1r1r168/receivable/USD ledger=144484 orders=145394`, `driver:a2f1r1d3/payable/USD ledger=-433574 orders=-434302`, `platform:main/revenue/USD ledger=-4968190 orders=-4969037`

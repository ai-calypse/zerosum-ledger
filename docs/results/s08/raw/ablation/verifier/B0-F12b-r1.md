# B0-F12b-r1 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label B0-F12b-r1"
```

## 7. Raw data

[B0-F12b-r1.json](B0-F12b-r1.json) — the same run, with every check's metrics and its sample of offending rows.

## 8. Results

| Invariant | What it checks | Result | Violations | Metrics |
|---|---|---|---|---|
| I1 | every money order is zero-sum per currency | **VIOLATED** | 2 | orders_checked=600, unbalanced_orders=2 |
...
| I7 | provider ground truth ↔ attempts: one provider success per attempt, none unclaimed | **VIOLATED** | 22 | attempts=300, provider_success_records=322, duplicate_charges=22, duplicate_minor=56482, success_without_provider_record=0, provider_success_without_attempt=0, provider_success_on_failed_attempt=0 |

**Overall: FAIL — I1, I2, I7 violated**

Offending rows:

- **I1** (first 2 of 2): `01a0b764-2c21-7819-b060-9320b4fbafe7: USD sums to -1`, `01a0b764-83a8-7c7e-bf50-359d53b1a30f: USD sums to -1`
- **I2** (first 1 of 1): `USD`
- **I7** (first 10 of 22): `CHARGE 01a0b763-b0c5-7b20-95ad-28496fa8c296 succeeded 2 times`, `CHARGE 01a0b763-b31f-77e8-a163-e80858fbf0e8 succeeded 2 times`, `CHARGE 01a0b763-b4b6-774f-9fd5-b552beaac4b9 succeeded 2 times`, `CHARGE 01a0b763-baee-7df2-bf8f-1ab4fdcc0183 succeeded 2 times`, `CHARGE 01a0b763-be0b-74c4-9ab0-ef16cd1b7412 succeeded 2 times`, `CHARGE 01a0b763-c201-7cd5-8eb1-6448e0ae71ef succeeded 2 times`, `CHARGE 01a0b763-c453-7aa8-b98f-49d2740eeff5 succeeded 2 times`, `CHARGE 01a0b763-c9bd-7f5b-9927-2be30d130758 succeeded 2 times`, `CHARGE 01a0b763-cc2b-7d68-b2f1-ab885c1695e6 succeeded 3 times`, `CHARGE 01a0b763-ce70-75f9-a850-3275bf6aaf56 succeeded 2 times`

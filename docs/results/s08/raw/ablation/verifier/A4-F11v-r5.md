# A4-F11v-r5 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A4-F11v-r5"
```

## 7. Raw data

[A4-F11v-r5.json](A4-F11v-r5.json) — the same run, with every check's metrics and its sample of offending rows.

## 8. Results

| Invariant | What it checks | Result | Violations | Metrics |
|---|---|---|---|---|
| I1 | every money order is zero-sum per currency | **VIOLATED** | 60 | orders_checked=6000, unbalanced_orders=60 |
...
- **I1** (first 10 of 60): `01a0b77e-60df-74c5-9110-3a82a1404a38: USD sums to 1`, `01a0b77e-ce71-7b3c-b226-5eb2acd11e84: USD sums to 1`, `01a0b77e-43a9-706e-a473-1eb2e2a6ed28: USD sums to -1`, `01a0b77e-8641-7ef3-b169-952933f408f4: USD sums to -1`, `01a0b77e-8f0c-70f9-91a6-2cd7a56d17f2: USD sums to -1`, `01a0b77e-7506-7d4c-82a9-54521efede72: USD sums to 1`, `01a0b77e-cc60-70bc-a07c-166cee42afb2: USD sums to -1`, `01a0b77e-76bf-7a8f-852c-17653e914a9a: USD sums to 1`, `01a0b77e-4d7f-74ad-b67a-6c2330a19392: USD sums to -1`, `01a0b77e-8e08-77c0-bd5a-2bd5d77a121c: USD sums to -1`
- **I2** (first 1 of 1): `USD`

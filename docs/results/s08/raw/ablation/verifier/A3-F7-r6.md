# A3-F7-r6 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A3-F7-r6"
```

## 7. Raw data

[A3-F7-r6.json](A3-F7-r6.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I7 | provider ground truth ↔ attempts: one provider success per attempt, none unclaimed | **VIOLATED** | 26 | attempts=200, provider_success_records=226, duplicate_charges=26, duplicate_minor=59790, success_without_provider_record=0, provider_success_without_attempt=0, provider_success_on_failed_attempt=0 |

**Overall: FAIL — I7 violated**

Offending rows:

- **I7** (first 10 of 26): `CHARGE 01a0b781-ae9d-75ce-859c-de67fac261f7 succeeded 2 times`, `CHARGE 01a0b781-b66a-7164-b220-b051deab04e7 succeeded 2 times`, `CHARGE 01a0b781-c417-7924-9f71-82025531b002 succeeded 2 times`, `CHARGE 01a0b781-d001-7ecc-8085-7111e0a7f9ab succeeded 2 times`, `CHARGE 01a0b781-d0e1-7112-ba91-0ad37beec45e succeeded 2 times`, `CHARGE 01a0b781-d8c2-7bff-82d0-6e5025a1f5fa succeeded 2 times`, `CHARGE 01a0b781-deb0-7ef7-9293-190ad4ef151d succeeded 2 times`, `CHARGE 01a0b781-e854-7546-b0b2-6b30f65831d8 succeeded 2 times`, `CHARGE 01a0b781-ee2e-791e-95b7-ffb638c165a4 succeeded 2 times`, `CHARGE 01a0b781-f016-75c5-a695-79d0ff873e0d succeeded 2 times`

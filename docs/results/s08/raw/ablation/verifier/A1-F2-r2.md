# A1-F2-r2 — invariants I1, I2, I3, I4, I6, I6b, I7
...
Ledger scope actually examined: **entities=251 accounts=251 changelog_rows=19518 applied_orders=6000**. Each database was read inside one read-only repeatable-read
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A1-F2-r2"
```

## 7. Raw data

[A1-F2-r2.json](A1-F2-r2.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 230 | accounts_compared=251, accounts_drifting=230, drift_abs_minor=2839750 |
...
- **I6b** (first 10 of 230): `rider:a1f2r2r186/receivable/USD ledger=71757 orders=67674`, `rider:a1f2r2r55/receivable/USD ledger=78303 orders=72057`, `driver:a1f2r2d15/payable/USD ledger=-252573 orders=-239725`, `driver:a1f2r2d30/payable/USD ledger=-293632 orders=-265502`, `rider:a1f2r2r29/receivable/USD ledger=104882 orders=96060`, `driver:a1f2r2d26/payable/USD ledger=-270212 orders=-264203`, `driver:a1f2r2d49/payable/USD ledger=-288179 orders=-259212`, `driver:a1f2r2d41/payable/USD ledger=-251508 orders=-231334`, `rider:a1f2r2r5/receivable/USD ledger=115580 orders=108140`, `rider:a1f2r2r117/receivable/USD ledger=86392 orders=76716`

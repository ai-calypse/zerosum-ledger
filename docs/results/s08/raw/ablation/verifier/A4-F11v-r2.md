# A4-F11v-r2 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A4-F11v-r2"
```

## 7. Raw data

[A4-F11v-r2.json](A4-F11v-r2.json) — the same run, with every check's metrics and its sample of offending rows.

## 8. Results

| Invariant | What it checks | Result | Violations | Metrics |
|---|---|---|---|---|
| I1 | every money order is zero-sum per currency | **VIOLATED** | 70 | orders_checked=6000, unbalanced_orders=70 |
...
- **I1** (first 10 of 70): `01a0b769-b81d-75df-a8c7-f937effca63f: USD sums to -1`, `01a0b769-2d17-77be-a356-ec10cb8ea8e6: USD sums to 1`, `01a0b769-58df-7c30-a877-556d6e115a53: USD sums to -1`, `01a0b769-8e83-7930-b8e0-6a2f2d9debcc: USD sums to 1`, `01a0b769-0948-716e-b0b1-2a0733685b76: USD sums to -1`, `01a0b769-25f1-7098-b9a9-7484f86cdedf: USD sums to -1`, `01a0b768-f7e3-7b09-b919-1e05ccb1a17b: USD sums to 1`, `01a0b769-1d7f-79f2-bfea-5c21ea03bda1: USD sums to 1`, `01a0b769-7cb3-7b1d-a470-9e797085c69d: USD sums to -1`, `01a0b769-aaab-7528-b262-1cad30629b69: USD sums to 1`
- **I2** (first 1 of 1): `USD`

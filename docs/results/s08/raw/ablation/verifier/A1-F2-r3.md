# A1-F2-r3 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A1-F2-r3"
```

## 7. Raw data

[A1-F2-r3.json](A1-F2-r3.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 231 | accounts_compared=251, accounts_drifting=231, drift_abs_minor=2720752 |
...
- **I6b** (first 10 of 231): `rider:a1f2r3r154/receivable/USD ledger=97235 orders=89946`, `rider:a1f2r3r153/receivable/USD ledger=115712 orders=91807`, `rider:a1f2r3r84/receivable/USD ledger=71147 orders=65890`, `rider:a1f2r3r121/receivable/USD ledger=87066 orders=74711`, `rider:a1f2r3r62/receivable/USD ledger=88274 orders=85225`, `driver:a1f2r3d2/payable/USD ledger=-290378 orders=-270907`, `driver:a1f2r3d19/payable/USD ledger=-280846 orders=-260185`, `driver:a1f2r3d45/payable/USD ledger=-318955 orders=-296980`, `driver:a1f2r3d22/payable/USD ledger=-263081 orders=-246675`, `rider:a1f2r3r73/receivable/USD ledger=80194 orders=78959`

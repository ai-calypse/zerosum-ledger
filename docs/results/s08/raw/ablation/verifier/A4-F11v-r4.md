# A4-F11v-r4 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A4-F11v-r4"
```

## 7. Raw data

[A4-F11v-r4.json](A4-F11v-r4.json) — the same run, with every check's metrics and its sample of offending rows.

## 8. Results

| Invariant | What it checks | Result | Violations | Metrics |
|---|---|---|---|---|
| I1 | every money order is zero-sum per currency | **VIOLATED** | 58 | orders_checked=6000, unbalanced_orders=58 |
...
- **I1** (first 10 of 58): `01a0b77a-2155-7ee4-8877-26cd4fc2adb7: USD sums to 1`, `01a0b779-8990-788e-b9c5-6beda67e9883: USD sums to -1`, `01a0b779-6751-7d6b-a006-a816cf211dd2: USD sums to 1`, `01a0b779-c9e5-7085-a1c8-b0e5687127fa: USD sums to -1`, `01a0b779-76bd-7e43-99db-ef1cff4a7bf7: USD sums to -1`, `01a0b77a-153e-7fca-b255-50a63ff46547: USD sums to -1`, `01a0b779-a74b-7dd3-8e72-0ae0c7c85580: USD sums to -1`, `01a0b779-d146-7aee-b226-53c1ac56362e: USD sums to -1`, `01a0b779-6ffd-7691-b026-03c612b833dd: USD sums to -1`, `01a0b77a-22bc-7800-b6a6-96bfd41a6f9d: USD sums to 1`
- **I2** (first 1 of 1): `USD`

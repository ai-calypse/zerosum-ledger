# B0-F12b-r6 — invariants I1, I2, I3, I4, I6, I6b, I7
...
Ledger scope actually examined: **entities=71 accounts=71 changelog_rows=1500 applied_orders=600**. Each database was read inside one read-only repeatable-read
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label B0-F12b-r6"
```

## 7. Raw data

[B0-F12b-r6.json](B0-F12b-r6.json) — the same run, with every check's metrics and its sample of offending rows.

## 8. Results

| Invariant | What it checks | Result | Violations | Metrics |
|---|---|---|---|---|
| I1 | every money order is zero-sum per currency | **PASS** | 0 | orders_checked=600, unbalanced_orders=0 |
...
| I7 | provider ground truth ↔ attempts: one provider success per attempt, none unclaimed | **VIOLATED** | 21 | attempts=300, provider_success_records=321, duplicate_charges=21, duplicate_minor=59667, success_without_provider_record=0, provider_success_without_attempt=0, provider_success_on_failed_attempt=0 |

**Overall: FAIL — I7 violated**

Offending rows:

- **I7** (first 10 of 21): `CHARGE 01a0b784-2813-7c3e-82df-075fb500dd65 succeeded 2 times`, `CHARGE 01a0b784-2e96-7f31-9048-79ab54e65be5 succeeded 2 times`, `CHARGE 01a0b784-2f59-792f-8ba5-27b7b9c4f801 succeeded 3 times`, `CHARGE 01a0b784-30ed-7248-8873-5c561f67bd8d succeeded 2 times`, `CHARGE 01a0b784-340e-7e62-8fc6-5bc392ef4f91 succeeded 3 times`, `CHARGE 01a0b784-373c-7d7f-8958-93b1b4521201 succeeded 2 times`, `CHARGE 01a0b784-3d76-78ae-a11e-b1b9a8048bf2 succeeded 2 times`, `CHARGE 01a0b784-43b7-762b-8171-c6402ec913ad succeeded 2 times`, `CHARGE 01a0b784-4b75-7fc7-8c3c-503f5c1d0bec succeeded 2 times`, `CHARGE 01a0b784-4c42-77d8-bb97-7bcc086e32c9 succeeded 2 times`

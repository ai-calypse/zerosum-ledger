# A2-F1-r2 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A2-F1-r2"
```

## 7. Raw data

[A2-F1-r2.json](A2-F1-r2.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 5 | accounts_compared=251, accounts_drifting=5, drift_abs_minor=13830 |
...
- **I6** (first 2 of 2): `not applied: 01a0b743-22ea-7457-a7c0-d453cc6c59f3`, `not applied: 01a0b743-d70a-71f7-8b32-935f9f9bdb89`
- **I6b** (first 5 of 5): `rider:a2f1r2r134/receivable/USD ledger=145412 orders=149456`, `rider:a2f1r2r39/receivable/USD ledger=151550 orders=154421`, `platform:main/revenue/USD ledger=-4950974 orders=-4952356`, `driver:a2f1r2d5/payable/USD ledger=-471996 orders=-474293`, `driver:a2f1r2d31/payable/USD ledger=-377417 orders=-380653`

# pilot-A1-F2-r1 — invariants I1, I2, I3, I4, I6, I6b, I7
...
| Item | Value |
|---|---|
| Git commit SHA | `11dde456ce335ef0d8ac73f03634f4e535466809`; working tree DIRTY — 4 uncommitted file(s); this result is not reproducible from the SHA alone |
...
Ledger scope actually examined: **entities=251 accounts=251 changelog_rows=18018 applied_orders=6000**. Each database was read inside one read-only repeatable-read
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label pilot-A1-F2-r1"
```

## 7. Raw data

[pilot-A1-F2-r1.json](pilot-A1-F2-r1.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 12 | accounts_compared=251, accounts_drifting=12, drift_abs_minor=29184 |
...
**Overall: FAIL — I6b violated**

Offending rows:

- **I6b** (first 10 of 12): `platform:main/revenue/USD ledger=-3274027 orders=-3271111`, `driver:pilota1f2r1d41/payable/USD ledger=-267029 orders=-266181`, `driver:pilota1f2r1d37/payable/USD ledger=-244203 orders=-242678`, `driver:pilota1f2r1d45/payable/USD ledger=-251553 orders=-247102`, `driver:pilota1f2r1d44/payable/USD ledger=-231803 orders=-230009`, `rider:pilota1f2r1r101/receivable/USD ledger=108468 orders=104646`, `rider:pilota1f2r1r10/receivable/USD ledger=66963 orders=65904`, `rider:pilota1f2r1r192/receivable/USD ledger=85362 orders=83456`, `driver:pilota1f2r1d31/payable/USD ledger=-252004 orders=-248946`, `rider:pilota1f2r1r40/receivable/USD ledger=80328 orders=77343`

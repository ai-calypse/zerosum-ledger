# A1-F2-r1 — invariants I1, I2, I3, I4, I6, I6b, I7
...
```sh
./gradlew :tools:verifier:run --args="--jdbc-url jdbc:postgresql://127.0.0.1:5432/ledger --orders-jdbc-url jdbc:postgresql://127.0.0.1:5432/orders --instruments-jdbc-url jdbc:postgresql://127.0.0.1:5432/instruments --providers-jdbc-url jdbc:postgresql://127.0.0.1:5432/fakeproviders --checks I1,I2,I3,I4,I6,I6b,I7 --env-file /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/.env --out /Users/yakshgandhi/Documents/Development/fintech-blogs/zerosum-ledger/infra/tests/build/evidence/ablation/verifier --label A1-F2-r1"
```

## 7. Raw data

[A1-F2-r1.json](A1-F2-r1.json) — the same run, with every check's metrics and its sample of offending rows.
...
| I6b | every ledger balance = Σ entries for that account across all orders in the order store | **VIOLATED** | 12 | accounts_compared=251, accounts_drifting=12, drift_abs_minor=35482 |
...
- **I6b** (first 10 of 12): `rider:a1f2r1r25/receivable/USD ledger=74381 orders=71658`, `rider:a1f2r1r183/receivable/USD ledger=78154 orders=73580`, `driver:a1f2r1d45/payable/USD ledger=-251553 orders=-247102`, `rider:a1f2r1r40/receivable/USD ledger=80328 orders=77343`, `platform:main/revenue/USD ledger=-3274656 orders=-3271111`, `driver:a1f2r1d31/payable/USD ledger=-252004 orders=-248946`, `driver:a1f2r1d14/payable/USD ledger=-262907 orders=-260728`, `rider:a1f2r1r10/receivable/USD ledger=66963 orders=65904`, `rider:a1f2r1r101/receivable/USD ledger=108468 orders=104646`, `driver:a1f2r1d41/payable/USD ledger=-267029 orders=-266181`

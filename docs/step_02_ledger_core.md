...
|---|---|---|---|
| Ledger read API specification | `openapi/ledger-service.yaml` | same (balances and changelog; invariants and verify added by S02-T05) | committed with S02-T04 |

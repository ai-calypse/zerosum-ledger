...
| Changelog hasher and chain verifier | `services/ledger-service/src/main/java/<package-root>/changelog/` | `services/ledger-service/src/main/java/dev/zerosum/ledger/changelog/` (`d69b9f6`; `ChainVerifier` added by S02-T06) | D02-6 |
...
|---|---|---|---|---|
| `docs/zerosum_ledger_mvp_plan.md` | `d65384c 2026-09-15` | 2026-09-15 (S02 start at `2f5dbcf`; rechecked at the Phase 1 and Phase 2 boundaries and again before handoff) | All | No impact: unchanged at all three rechecks |

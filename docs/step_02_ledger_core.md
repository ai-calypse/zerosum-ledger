...
|---|---|---|---|---|
| Schema migrates from baseline and validates | `LedgerSchemaMigrationIT` | Not run | — | — |
| Append-only enforcement per table, operation and identity | `LedgerAppendOnlyIT` | Not run | — | — |
| Runtime and verifier grants | `LedgerGrantsIT` | Not run | — | — |
